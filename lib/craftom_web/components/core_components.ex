defmodule CraftomWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-[20px] font-medium leading-[28px]  ",
        @class
      ]}
      {@rest}
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CraftomWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CraftomWeb.Gettext, "errors", msg, opts)
    end
  end
